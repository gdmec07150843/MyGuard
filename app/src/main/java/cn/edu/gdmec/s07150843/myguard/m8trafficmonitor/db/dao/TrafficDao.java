package cn.edu.gdmec.s07150843.myguard.m8trafficmonitor.db.dao;
...
import cn.edu.gdmec.s07150843.myguard.m8trafficmonitor.db.TrafficOpenHelper;
...
public class TrafficDao {
    ...
    public void insertTodayGPRS(long gprs) {
        SQLiteDatabase db = helper.getReadableDatabase();
        Date dNow = new Date();
        Calendar calendar = Calendar.getInstance(); // 得至!j日历
