...
import cn. edu. gdmec. s07150843. myguard. m6cleancache. adapter. CacheCleanAdapter;
...
//在主线程添加变化后的集合
                ...
                case FINISH:
                    ...
                    animation.stop();
                    if (cacheMemory > 0) {
                        mCacheStn.setEnabled(true);
                    } else {
                        mCacheStn.setEnabled(false);
