package cn.edu.gdmec.s07150843.myguard.m8trafficmonitor;
...
import cn.edu.gdmec.s07150843.myguard.m8trafficmonitor.db.dao.TrafficDao;
...
public class TrafficMonitoringActivity extends AppCompatActivity implements View. OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!SystemInfoUtils
                .isServiceRunning(this,
                        "cn.edu.gdmec.s07150843. myguard. m8trafficmonitor. service. TrafficMonitoringService")) {
    ...
    private void initData() {
        ...
        mUsedTV.setText("本月己用" + Formatter.formatFileSize(this, usedflow));
        ...
        mToDayTV.setText("本日己用：" + Formatter.formatFileSize(this, moblieGPRS));
    }
