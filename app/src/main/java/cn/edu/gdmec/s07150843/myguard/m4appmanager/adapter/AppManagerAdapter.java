package cn.edu.gdmec.s07150843.myguard.m4appmanager.adapter;
...
import cn.edu.gdmec.s07150843.myguard.m4appmanager.utils.DensityUtil;
import cn.edu.gdmec.s07150843.myguard.m4appmanager.utils.EngineUtils;
...
public class AppManagerAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView!=null&convertView instanceof LinearLayout){
            ...
            viewHolder.mSettomgAppTV=(TextView)convertView.findViewById(R.id.tv_setting_app);
        ...
        viewHolder.mSettomgAppTV.setOnClickListener(listener);
            ...
            switch (v.getId()){
                ...
                case R.id.tv_uninstall_app:
                    if(appInfo.packageName.equals(context.getPackageName())){
                        Toast.makeText(context,"您没有权限卸载妨该应用！",Toast.LENGTH_SHORT).show();
                        return;
                    }
